...
const MenuModal = ({ isOpen, onClose }) => {
  ...
  return (
    <MenuModalWrapper className="flex fixed inset-0 z-50 justify-center items-center">
      <div
        className="fixed inset-0 opacity-70 bg-slate-900"
        onClick={onClose}
      ></div>
      <div className="relative z-50 p-16 w-full max-w-xl bg-purple-700 rounded-2xl shadow-lg select-none modal_box">
